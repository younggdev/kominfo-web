...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($_FILES['foto']['name'])) {
        ...
        $lokasi_berkas_baru = '../foto/pegawai/' . $nama_berkas_acak_baru;
        ...
        $lokasi_berkas_lama = '../foto/pegawai/' . $nama_berkas_lama;
        ...
        move_uploaded_file($file_tmp, '../foto/pegawai/' . $nama_berkas_acak_baru);

        // Lakukan koneksi ke database ($koneksi) di sini
        $query = mysqli_query($koneksi, "UPDATE profil_pegawai SET nama='$nama', jabatan='$jabatan', bidang='$bidang', foto='$nama_berkas_acak_baru' WHERE id='$id'");
    } else {
        // Lakukan koneksi ke database ($koneksi) di sini
        $query = mysqli_query($koneksi, "UPDATE profil_pegawai SET nama='$nama', jabatan='$jabatan', bidang='$bidang' WHERE id='$id'");
    }
