...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $lokasi_berkas = '../foto/berita/' . $nama_berkas_acak;
    ...
    move_uploaded_file($file_tmp, '../foto/berita/' . $nama_berkas_acak);

    $query = mysqli_query($koneksi, "INSERT INTO berita VALUES ('', '$judul', '$teks', '$nama_berkas_acak', '$tanggal')");
