                 ...
                 <?php
                  ...
                  ?>
                   <tr>
                     ...
                     <td><?= $data['jabatan'] ?></td>
                     <td><?= $data['bidang'] ?></td>
                     <td><img src="foto/pegawai/<?= $data['foto'] ?>" alt="" width="100px"></td>
                     <td>
                       <a onclick="hapus_data(<?= $data['id'] ?>)" class="btn btn-sm btn-danger">Hapus</a>
                       <a href="index.php?page=edit-data&&id=<?= $data['id'] ?>" class="btn btn-sm btn-success">Edit</a>
                     </td>
                   </tr>
                 <?php } ?>
               </tbody>
 ...
 <div class="modal fade" id="modal-lg">
   <div class="modal-dialog modal-lg">
     <div class="modal-content">
       ...
       <form action="add/tambah_data_pegawai.php" method="post" enctype="multipart/form-data">
   ...
   function hapus_data(data_id) {
     ...
     Swal.fire({
       ...
       if (result.isConfirmed) {
         Swal.fire(
           window.location = ("delete/hapus_data_pegawai.php?id=" + data_id)
         )
       }
     })
   }
