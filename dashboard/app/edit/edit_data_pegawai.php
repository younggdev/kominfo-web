...
<section class="content">
    <div class="container-fluid">
        <div class="card card-warning">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form method="post" action="update/update_data_pegawai.php" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-sm-6">
                            <!-- text input -->
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <img src="foto/pegawai/<?= $view['foto'] ?>" alt="" width="200px" class="rounded float-right">
                        </div>
                    </div>
                    <div class="row">
